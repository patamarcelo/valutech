    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('image', models.ImageField(blank=True, default='images/User1.jpg', upload_to='images/')),
                ('api_key', models.CharField(blank=True, max_length=200, null=True, verbose_name='Api Key')),
                ('api_secret', models.CharField(blank=True, max_length=200, null=True, verbose_name='Api Secret')),
