...
<aside class="main-sidebar sidebar-dark-primary  elevation-4">
    ...
    {% block logo %}
        <a href="/" class="brand-link">
            <img src="{%static 'admin-lte/dist/img/V_sem_contorno.png' %}" alt="AdminLTE Logo" class="brand-image img-circle elevation-3" style="opacity: 1;">
            {% block logo_text %}<span class="brand-text font-weight-light ml-1">Valutech </span>{% endblock %}
        </a>
    {% endblock %}
