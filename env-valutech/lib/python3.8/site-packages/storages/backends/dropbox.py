...
class DropBoxStorage(Storage):
    ...
    def __init__(self, oauth2_refresh_token=oauth2_refresh_token, app_key=app_key, app_secret=app_secret, root_path=location, timeout=timeout,
                 write_mode=write_mode):
        if oauth2_refresh_token is None:
            raise ImproperlyConfigured("You must configure an auth refresh token at"
